...
3. Build FuzzilliJs as you would the other fuzzers. [See ReadMe.md in the parent folder.](https://github.com/Clark-E/inclusive-serenity/blob/master/Meta/Lagom/ReadMe.md)
